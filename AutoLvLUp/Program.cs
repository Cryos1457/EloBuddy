...
namespace AutoSpellUp
{
    ...
    internal class Program
    {
        ...
        private static void Game_OnStart(EventArgs args)
        {
            ...
            {
                case "Aatrox":
                    AbilitySequence = new[] { 3, 2, 1, 3, 3, 4, 3, 2, 3, 2, 4, 2, 2, 1, 1, 4, 1, 1 };
                    break;
                case "Ahri":
                ...
                case "Cassiopeia":
                    ...
                    break;
                case "Chogath":
                    AbilitySequence = new[] { 3, 2, 1, 2, 2, 4, 2, 1, 2, 1, 4, 1, 1, 3, 3, 4, 3, 3 };
                    break;
                case "Corki":
                ...
                case "Darius":
                    ...
                    break;
                case "Diana":
                    AbilitySequence = new[] { 2, 1, 2, 3, 1, 4, 1, 1, 1, 2, 4, 2, 2, 3, 3, 4, 3, 3 };
                    break;
                case "DrMundo":
                    AbilitySequence = new[] { 1, 3, 2, 1, 1, 4, 1, 3, 1, 3, 4, 3, 3, 2, 2, 4, 2, 2 };
                    break;
                ...
                case "Ezreal":
                    ...
                    {
                        AbilitySequence = new[] { 1, 2, 3, 2, 2, 4, 2, 3, 2, 3, 4, 3, 3, 1, 1, 4, 1, 1 };
                        Tipo = " AD";
                    }
                    else
                    {
                ...
                case "Fiora":
                    ...
                    break;
                case "Fizz":
                    AbilitySequence = new[] { 2, 1, 3, 3, 3, 4, 3, 2, 3, 2, 4, 2, 2, 1, 1, 4, 1, 1 };
                    break;
                case "Galio":
                    AbilitySequence = new[] { 1, 3, 2, 1, 1, 4, 1, 3, 1, 3, 4, 3, 3, 2, 2, 4, 2, 2 };
                    break;
                ...
                case "JarvanIV":
                    ...
                    break;
                case "Jax":
                    AbilitySequence = new[] { 3, 1, 2, 2, 2, 4, 2, 1, 2, 1, 4, 1, 1, 3, 3, 4, 3, 3 };
                    break;
                case "Jayce":
                    AbilitySequence = new[] { 1, 3, 2, 1, 1, 2, 1, 2, 1, 2, 1, 2, 2, 3, 3, 3, 3, 3 };
                    ROff = -1;
                    break;                
                case "Jhin":
                    AbilitySequence = new[] { 1, 2, 3, 1, 1, 4, 1, 2, 1, 2, 4, 2, 2, 3, 3, 4, 3, 3 };
                ...
                case "Katarina":
                    ...
                    break;
                case "Kalista":
                    AbilitySequence = new[] { 3, 2, 1, 3, 3, 4, 1, 3, 3, 1, 4, 1, 1, 2, 2, 4, 2, 2 };
                    break;
                case "Kayle":
                    AbilitySequence = new[] { 3, 1, 2, 3, 3, 4, 3, 1, 3, 1, 4, 1, 1, 2, 2, 4, 2, 2 };
                     if (smite != null && smite.Slot != SpellSlot.Unknown)
                    {
                        AbilitySequence = new[] { 3, 2, 3, 1, 3, 4, 3, 1, 3, 1, 4, 1, 1, 2, 2, 4, 2, 2 };
                        Tipo = " Jungle";
                    }
                    else
                    {
                ...
                case "KogMaw":
                    if (heal != null && heal.Slot != SpellSlot.Unknown)
                    {
                        AbilitySequence = new[] { 2, 3, 2, 3, 2, 4, 2, 3, 2, 3, 4, 3, 1, 1, 1, 4, 1, 1 };
                        Tipo = " AD";
                    }
                    else
                    {
                ...
                case "Malphite":
                    ...
                    break;
                case "Malzahar":
                    AbilitySequence = new[] { 3, 1, 3, 2, 3, 4, 3, 1, 3, 1, 4, 1, 1, 2, 2, 4, 2, 2 };
                    break;
                case "Maokai":
                    if (smite != null && smite.Slot != SpellSlot.Unknown)
                    {
                ...
                case "Nidalee":
                    ...
                    break;
                case "Nocturne":
                    AbilitySequence = new[] { 1, 2, 3, 1, 1, 4, 1, 3, 1, 3, 4, 3, 2, 3, 2, 4, 2, 2 };
                    break;
                case "Nunu":
                    if (smite != null && smite.Slot != SpellSlot.Unknown)
                    {
                ...
                case "Rengar":
                    ...
                    break;
                case "Riven":
                    AbilitySequence = new[] { 1, 3, 2, 1, 1, 4, 1, 3, 1, 3, 4, 3, 3, 2, 2, 2, 2, 2 };
                    break;
                case "Rumble":
                    AbilitySequence = new[] { 1, 2, 3, 1, 1, 4, 1, 3, 1, 3, 4, 3, 3, 2, 2, 4, 2, 2 };
                    break;
                ...
                case "Trundle":
                    ...
                    break;
                case "Tryndamere":
                    AbilitySequence = new[] { 3, 1, 1, 2, 1, 4, 1, 3, 1, 3, 4, 3, 3, 2, 2, 4, 2, 2 };
                    break;
                case "TwistedFate":
                    AbilitySequence = new[] { 2, 1, 3, 1, 1, 4, 1, 2, 1, 2, 4, 2, 2, 3, 3, 4, 3, 3 };
                    break;
                case "Twitch":
                    ...
                    break;
                case "Udyr":
                    AbilitySequence = new[] { 4, 2, 3, 4, 4, 2, 4, 2, 4, 2, 2, 3, 3, 3, 3, 1, 1, 1 };
                    break;
                case "Urgot":
                    AbilitySequence = new[] { 1, 3, 2, 1, 1, 4, 1, 3, 1, 3, 4, 3, 3, 2, 2, 4, 2, 2 };
                    break;
                ...
                case "Velkoz":
                    ...
                    break;
                case "Vi":
                    AbilitySequence = new[] { 2, 3, 1, 1, 1, 4, 1, 3, 1, 3, 4, 3, 3, 2, 2, 4, 2, 2 };
                    break;
                case "Viktor":
                    AbilitySequence = new[] { 3, 1, 3, 2, 3, 4, 3, 1, 3, 1, 4, 1, 1, 2, 2, 4, 2, 2 };
                    break;
                ...
                case "Volibear":
                    ...
                    break;
                case "Warwick":
                    AbilitySequence = new[] { 2, 1, 1, 3, 1, 4, 1, 3, 1, 3, 4, 3, 3, 2, 2, 4, 2, 2 };
                    break;
                case "MonkeyKing":
                    AbilitySequence = new[] { 3, 1, 2, 3, 3, 4, 3, 1, 3, 1, 4, 1, 1, 2, 2, 4, 2, 2 };
                    break;
